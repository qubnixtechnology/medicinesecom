...
// import { ArrowRight, Shield, Truck, Clock, Award, Star, Phone, Mail, MapPin } from 'lucide-react';
...
//               <Link
//                 href="/products"
//                 className="inline-flex items-center justify-center gap-2 bg-white text-blue-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg text-lg"
//               >
//                 Shop Now <ArrowRight size={20} />
//               </Link>
//               <Link
//                 href="/categories/neurological-support"
//                 className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-700 transition text-lg"
//               >
//                 Explore Categories
//               </Link>
//             </div>
...
//               </div>
//               <h3 className="font-semibold text-gray-800">WHO-GMP Certified</h3>
...
//                 className={`${cat.color} p-6 rounded-xl hover:shadow-lg transition-all duration-300 group transform hover:-translate-y-1`}
//               >
//                 <div className="flex items-center gap-4">
//                   <div className={`text-5xl ${cat.textColor}`}>{cat.icon}</div>
//                   <div>
//                     <h3 className={`text-xl font-bold ${cat.textColor} group-hover:underline`}>
//                       {cat.name}
//                     </h3>
...
//             <p className="text-xl mb-6">Get up to 20% off on all nutritional supplements</p>
//             <Link 
...
//               <p className="text-gray-600 mt-1">Recently added products to our collection</p>
//             </div>
//             <Link 
//               href="/products" 
//               className="text-blue-600 hover:text-blue-700 flex items-center gap-1 font-semibold"
...
//               <h3 className="text-xl font-bold text-gray-800 mb-6">Our Strengths</h3>
//               <div className="space-y-4">
//                 {[
//                   'High-quality formulations with certified standards',
...
//             At Glance Healthcare, quality is our top priority. Every product undergoes strict quality control and complies with national and international healthcare standards to ensure maximum safety and effectiveness.
//           </p>
//           <div className="flex flex-wrap justify-center gap-4">
//             <span className="bg-blue-800 px-4 py-2 rounded-full">✓ WHO-GMP Certified</span>
//             <span className="bg-blue-800 px-4 py-2 rounded-full">✓ ISO 9001:2015</span>
//             <span className="bg-blue-800 px-4 py-2 rounded-full">✓ FSSAI Approved</span>
//             <span className="bg-blue-800 px-4 py-2 rounded-full">✓ GMP Compliant</span>
//           </div>
//         </div>
//       </section>
...
//               <p className="text-xs text-gray-500">Best Healthcare Brand 2024</p>
//             </div>
//             <div>
//               <div className="text-3xl mb-2">🔬</div>
//               <p className="font-semibold text-gray-800">Scientific Research</p>
//               <p className="text-xs text-gray-500">Evidence-based formulations</p>
//             </div>
//             <div>
//               <div className="text-3xl mb-2">💚</div>
...
//             <div>
//               <div className="text-3xl mb-2">🚚</div>
//               <p className="font-semibold text-gray-800">Fast Shipping</p>
...
//         {/* Wave SVG - Hidden on mobile for better performance */}
...
//       {/* WhatsApp Floating Button - Adjusted for mobile */}
//       <a
...
//       {/* ================= ABOUT SECTION (ENHANCED WITH 2 IMAGES) ================= */}
//       <section className="py-12 sm:py-16 bg-gray-50">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
//             {/* RIGHT IMAGES - 2 images with proper sizing */}
