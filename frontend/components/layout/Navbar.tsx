...
//               <Heart size={20} />
//               {mounted && user && totalWishlistItems > 0 && (
...
//                 <Heart size={16} />
//                 Wishlist {mounted && user && totalWishlistItems > 0 && `(${totalWishlistItems})`}
//               </Link>
